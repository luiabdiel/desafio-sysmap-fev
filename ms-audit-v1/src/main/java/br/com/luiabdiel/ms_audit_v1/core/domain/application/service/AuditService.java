...
public class AuditService implements AuditPortIn {
    ...
    public Page<AuditResponseDto> findAll(Pageable pageable) {
        ...
        Page<AuditCustomerEntity> auditCustomerEntities = this.auditPortOut.findAll(pageable);

        return auditCustomerEntities.map(entity -> this.modelMapper.map(entity, AuditResponseDto.class));
    }
}
